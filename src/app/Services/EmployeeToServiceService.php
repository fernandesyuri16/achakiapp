...
use App\Repositories\EmployeeToServiceRepository;

class EmployeeToServiceService
{
    use Http;

    private EmployeeToServiceRepository $repository;

    public function __construct()
    {
        $this->repository = new EmployeeToServiceRepository;
    }
